    ...
    return (
        <div className="flex w-full justify-center p-2 mb-2 flex-wrap">
            <div className="flex w-[1024px] min-h-36 flex-wrap gap-2 content-start">
                ...
                <div
                    className="w-full flex gap-1 content-center items-center flex-wrap">
                    <div
                        className="flex justify-center items-center font-black text-sm w-4 h-4 bg-[#808080] rounded-[3px]">
                        <span className="text-[rgb(233,233,233)] dark:text-black font-black">K</span>
                    </div>
                    <div className="flex flex-col">
                        <span
                            className="w-full text-[9px] font-black text-[#808080] leading-[90%]">KIRSI BLOG</span>
                    </div>
                </div>
                <div className="flex w-full items-center flex-wrap">
                    ...
                    <div className="flex w-full gap-2 items-center">
                        <span
                            className="text-[#808080] text-[12px] min-w-[45px]">©2024 silvercherry.io all rights reserved.</span>
                    </div>
                </div>
                <div className="flex w-full gap-2 items-center">
                    <div className="flex gap-[2px]">
                        <NginxIcon className="fill-[#808080] w-4 h-4"/>
                        <span className="text-[#808080] font-bold text-[9px]">NginX</span>
                    </div>
                    <div className="flex gap-[2px]">
                        <NestIcon className="fill-[#808080] w-4 h-4"/>
                        <span className="text-[#808080] font-bold text-[9px]">Nest.js</span>
                    </div>
                    <div className="flex gap-[2px]">
