...
const FloatButton = () => {
    ...
    return (
        <div className="mt-4 flex justify-end gap-2 flex-col fixed right-8 bottom-6">
            <div onClick={scrollToTop} ref={bounceRef} className={`px-2 py-2 font-bold rounded-[8px] bg-black dark:bg-white dark:text-black cursor-pointer transition-all duration-1000 ${scrollPos > 100 ? "opacity-100" : "opacity-0"}`}><ChevronUpIcon className="w-4 h-4"/></div>
